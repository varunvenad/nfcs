            ...
            <div class="card">
              <div class="card-body p-5">
                <header class="text-center mb-5">
                  <h1 class="text-xxl text-gray-400 text-uppercase">NFCS<strong class="text-primary">LOGIN</strong></h1>
                  ...
                  <div class="row">
                    <div class="col-lg-7 mx-auto">
                      <div class="input-material-group mb-3">
                        <input class="input-material" id="login-username" type="text" name="username" autocomplete="off">
                    ...
                    <div class="col-12 text-center">       
                      <input class="btn btn-primary mb-3" id="login" name="loginsubmit" type="submit"><br><a class="text-xs text-paleBlue" href="#!">Forgot Password?  </a><br><span class="text-xs mb-0 text-gray-500">Do not have an account?  </span><a class="text-xs text-paleBlue ms-1" href="register.html"> Signup</a>
