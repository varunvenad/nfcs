            ...
            <div class="container">
                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">NFCS</a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            ...
                            <li><a class="color_animation" href="user_profile.php">View Profile</a></li>
                            <li><a class="color_animation" href="#beer">View Item/Book</a></li>
                            <li><a class="color_animation" href="#beer">View/Take Packages</a></li>
                            <li><a class="color_animation" href="#beer">View/Take Offers</a></li>
                            <li><a class="color_animation" href="#beer">Food Basket</a></li>
                            <li><a class="color_animation" href="#beer">Booked Details</a></li>
                            <li><a class="color_animation" href="#beer">Give/View Feedback</a></li>
                            <li><a class="color_animation" href="#beer">Login</a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                </div>
            </div><!-- /.container-fluid -->
        ...
        <div id="top" class="starter_container bg">
            <div class="follow_container">
                <div class="col-md-6 col-md-offset-3">
                    <h2 class="top-title"> NFCS</h2>
                    <h2 class="white second-title">" Best in serving "</h2>
                    <hr>
                </div>
            </div>
        </div>
        ...
        <section id="story" class="description_content">
            <div class="text-content container">
                <div class="col-md-6">
                    ...
                    <p class="desc-text">NFCS is one of the best catering service in providing the vegetarian food to the customers. We have the best experienced team in cooking. </p>
                </div>
                <div class="col-md-6">
